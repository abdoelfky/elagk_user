...
import 'package:elagk/auth/presentation/controller/forget_passord_controller/forget_passowrd_state.dart';
...
if(state is OtpPasswordInitialState||(duration==Duration(seconds: 0) && state is !ChangeDurationEndState))
